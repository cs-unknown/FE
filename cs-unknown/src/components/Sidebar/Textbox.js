...
const Textbox = () => {
    ...
    useEffect(()=> {
        ...
        error_msg ? setText(`${error_msg}`) : (setText([...text] + `you have entered ${title}` + `${description}`))
        players ? setText(`players with you: ${players}`) : setText("you are alone in this room") 
